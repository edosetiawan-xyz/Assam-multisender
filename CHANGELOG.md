...
Repository: [edosetiawan-xyz/Assam-multisender](https://github.com/edosetiawan-xyz/Assam-multisender.git)
...
Script baru (Assam-multisender.js) merupakan versi yang telah disempurnakan dari script lama (Assam-multisender-beta.js) dengan berbagai peningkatan signifikan dalam hal antarmuka pengguna, fungsionalitas, penanganan data, notifikasi, dan optimasi teknis.
...
RPC_URL=https://assam-rpc.tea.xyz/ tambahkan (koma) jika lebih dari 1 RPC
